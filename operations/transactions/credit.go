...
// NewCreditAssembly returns new instance with prepared HTTP request data CreditAssembly
func NewCreditAssembly() *CreditAssembly {
...
// Implement methods for CreditAssembly structure, form pck structures OperationRequestInterface

// GetHTTPMethod return HTTP method which will be used for send request
func (op *CreditAssembly) GetHTTPMethod() string {
